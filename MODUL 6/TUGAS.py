...
m1=mahasiswa("Aiza", 144, "Samarinda", 250000)
m2=mahasiswa("Bella", 158, "Jakarta", 350000)
m3=mahasiswa("Chiara", 124, "Bontang", 220000)
m4=mahasiswa("Deena", 104, "Cimahi", 200000)
m5=mahasiswa("Elvira", 120, "Magetan", 205000)
