...
class Mahasiswa(Manusia):
    ...
    def __init__(self,nama,NIM,kota,us):
        ...
        self.uangsaku = us
    def __str__(self):
        s = self.nama +",NIM"+ str(self.NIM)\+",tinggaldi" + self.kotatinggal \
            +", uangsaku Rp" + str(self.uangsaku) \+"tiap bulannya"
        return s
    def ambilnama (self):
        return self.nama
    def ambilNIM(self):
    ...
    def makan(self,s):
        """metode ini menutupi metode 'makan' nya classs manusia.mahasiswa kalau makan sambil belajar."""
